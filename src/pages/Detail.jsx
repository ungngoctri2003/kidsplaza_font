...
export default function Detail() {
  ...
  const handleNavigate = (item) => {
    navigate(
      `/detail/${formatVietnameseToString(item?.name ? item?.name : "404")}/${
        item?.id
      }`
    );
  };
            ...
            <Row className="image_detail">
              ...
              <Col span={12} className="item_boxDetail">
                <div className="information_products">
                  ...
                  <p className="describe_detail">
                    <strong>Describe:</strong> {itemDetails?.describe}
                  </p>
                  <p className="describe_detail">
                    <strong>Species</strong> {itemDetails?.species}
                  </p>
                </div>
              </Col>
            </Row>
